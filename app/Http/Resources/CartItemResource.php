...
class CartItemResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'lens_name' => $this->lens->name ?? $this->lensOption->name ?? null,
            'lens_requires_prescription' => (bool) ($this->lens->requires_prescription ?? false),
            'lens_option_id' => $this->lens_option_id,
            'lens_option_name' => $this->lensOption->name ?? null,
            'prescription_type' => $this->prescription_type,
            'prescription' => $this->prescription_data,
            'quantity' => $quantity,
