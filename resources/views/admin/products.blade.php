...
<button class="flex items-center gap-2 h-10 px-5 rounded-xl bg-primary text-white text-sm font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20">
...
<tr>
<td colspan="6" class="px-6 py-8 text-center text-[#4c739a]">Đang tải dữ liệu...</td>
</tr>
</tbody>
</table>
</div>
...
<span id="total-inventory" class="text-xl font-black">0 <span class="text-sm font-medium text-emerald-500 text-xs ml-1">+0%</span></span>
</div>
</div>
<div class="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-[#cfdbe7] dark:border-slate-800 shadow-sm flex items-center gap-4">
...
function renderProducts(products) {
    if (products.length === 0) {
        document.getElementById('products-table-body').innerHTML = 
            '<tr><td colspan="6" class="px-6 py-8 text-center text-[#4c739a]">Không có sản phẩm nào</td></tr>';
        return;
    }
